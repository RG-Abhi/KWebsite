import { ACADEMIC_CALENDAR_ROWS } from '../src/data/academicCalendarData.js';
import { ENDOWMENT_AWARD_SECTIONS } from '../src/data/endowmentAwardsData.js';
...
const INITIAL_NAV_ITEMS = [
  {
    ...
    items: [
      ...
      { icon: 'fa-user-gear', title: 'Director', desc: 'Academic leadership', section: 'about/director-academic' },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: 'fa-file-signature', title: 'Admission Procedure', desc: 'How to apply', section: 'admissions/eligibility' },
  ...
  },
  {
    ...
    columns: [
      ...
      },
      {
        ...
        links: [
          { label: 'Tessellator', section: 'tools/tessellator', icon: 'fa-cube' },
          { label: 'LMS', section: 'tools/lms', icon: 'fa-book-open-reader' },
          { label: 'Teleuniv', section: 'tools/teleuniv', icon: 'fa-tower-broadcast' },
          { label: 'KMIT TV', section: 'tools/tv', icon: 'fa-tv' },
          { label: 'ICT', section: 'tools/ict', icon: 'fa-desktop' },
        ]
      }
    ]
  },
  {
    ...
    columns: [
      ...
      },
      {
        title: 'Student Life',
        links: [
          { label: 'Co-curriculars', section: 'student-life', icon: 'fa-users' },
          { label: 'Extra-curriculars', section: 'student-life/extra', icon: 'fa-music' },
...
export const INITIAL_DATA = {
  ...
  announcements: [
    "🎓 B.Tech Admissions 2025 — Applications Now Open. Apply Early!",
  ...
  heroSlides: [
    {
      src: 'https://kmit.in/adminpanel/json_data/uploadImages/assets/banner/SIH-Winners_2025.jpg',
      unsplash: '',
      alt: 'Congratulations to Team ASHTOJ for winning SIH 2025!',
    },
    {
      src: 'https://kmit.in/adminpanel/json_data/uploadImages/assets/banner/Smart-India-Hackathon-2025.jpg',
      unsplash: '',
      alt: 'Smart India Hackathon 2025',
    },
    {
      src: 'https://kmit.in/adminpanel/json_data/uploadImages/assets/banner/24-hours-hacakthon-2025.jpg',
      unsplash: '',
      alt: '24 Hours Hackathon 2025',
    },
    {
      src: 'https://kmit.in/adminpanel/json_data/uploadImages/assets/banner/Hyderabad Entrepreneurship Summit 2025.jpg',
      unsplash: '',
      alt: 'Hyderabad Entrepreneurship Summit 2025',
    },
    {
      src: "https://kmit.in/adminpanel/json_data/uploadImages/assets/banner/Navraas'25.jpg",
      unsplash: '',
      alt: 'Navraas 2025',
    },
    {
      src: 'https://kmit.in/adminpanel/json_data/uploadImages/assets/banner/Independence-day-celebrations-2025.jpg',
      unsplash: '',
      alt: 'INDEPENDENCE DAY CELEBRATIONS 2025',
    },
    {
      src: 'https://kmit.in/adminpanel/json_data/uploadImages/assets/banner/Gradution-Day-2025.jpg',
      unsplash: '',
      alt: 'Graduation Day 2025',
    },
    {
      src: 'https://kmit.in/adminpanel/json_data/uploadImages/assets/banner/prakalp 2025 project expo-min.png',
      unsplash: '',
      alt: 'Prakalp 2025 Project Expo',
    },
  ],
  stats: [
  ...
  whyChoose: [
    {
      ...
      local: '/photos/annualevents/patang_2026.jpeg'
    },
    {
      ...
      local: '/photos/annualevents/Orientation_day_25.jpg'
    },
    {
    ...
    },
    {
      ...
      local: '/photos/annualevents/patang_2025.jpg'
    },
    {
    ...
    },
    {
      ...
      local: '/photos/annualevents/prakalp_expo.jpg'
    },
    {
      ...
      local: '/photos/annualevents/Independence_Day_25.jpg'
    },
    {
    ...
    },
    {
      ...
      local: '/photos/annualevents/Saanjh_25.jpg'
    }
  ],
  explore: [
    {
    ...
    },
    {
      ...
      local: '/photos/annualevents/Graduation_day_25.jpg'
    },
    {
      ...
      local: '/photos/annualevents/Dandiya_night_25.jpg'
    },
    {
  ...
  deptDetails: {
    cse: {
      code: 'CSE', name: 'Computer Science & Engineering', intake: 300, established: 2007, nba: true,
      desc: 'Focused on coding excellence and core software engineering principles with an emphasis on industry readiness.',
      highlights: [
        'NBA Accredited Programme', 'Annual Intake: 300 students', 'Established in 2007',
    ...
    it: {
      code: 'IT', name: 'Information Technology', intake: 60, established: 2007, nba: true,
      desc: 'Managing information systems and the full software lifecycle from architecture to deployment.',
      highlights: [
        'NBA Accredited Programme', 'Annual Intake: 60 students', 'Established in 2007',
  ...
  pages: {
    ...
    'about/vision': {
      hero: { eyebrow: 'Our Philosophy', title: 'Vision & Mission', text: "KMIT's guiding philosophy is centered on producing world-class engineers who are technically proficient, ethically grounded, and globally competitive." },
      sections: [
        { type: 'text', eyebrow: 'Vision', title: 'Our Vision', content: ['"To become a globally recognised institution of technical excellence, nurturing innovative engineers who contribute meaningfully to society and industry."', 'KMIT aspires to be a premier engineering institution that not only imparts technical knowledge but fosters a culture of continuous learning, ethical behaviour, and societal responsibility. We aim to produce graduates who are not just job-ready, but future-ready.'] },
        { type: 'cards', eyebrow: 'Mission', title: 'Our Mission', items: [
          { title: 'Quality Education', desc: 'Provide high-quality technical education aligned with global industry standards.', icon: 'fa-1' },
          { title: 'Research Culture', desc: 'Foster a research-oriented environment through dedicated R&D centres and labs.', icon: 'fa-2' },
          { title: 'Industry Connect', desc: 'Enable industry partnerships for real-world learning and placement excellence.', icon: 'fa-3' },
          { title: 'Holistic Growth', desc: 'Cultivate leadership, communication, and professional skills through holistic programs.', icon: 'fa-4' },
          { title: 'Social Responsibility', desc: 'Promote social responsibility through NSS, co-curriculars, and community initiatives.', icon: 'fa-5' },
        ]},
        { type: 'cards', eyebrow: 'Core Values', title: 'What We Stand For', items: [
          { icon: 'fa-lightbulb', title: 'Innovation', desc: 'Fostering creative thinking and technological innovation through project-based, research-driven learning.' },
          { icon: 'fa-scale-balanced', title: 'Ethics & Integrity', desc: 'Building engineers who demonstrate strong ethical responsibility and professional integrity.' },
          { icon: 'fa-globe', title: 'Global Competitiveness', desc: 'Preparing graduates to excel in international arenas through industry-focused curriculum.' },
          { icon: 'fa-users', title: 'Holistic Development', desc: 'Nurturing well-rounded individuals through co-curricular activities and leadership.' },
        ]}
      ]
    },
    'about/leadership': {
      hero: { eyebrow: 'Management', title: 'Our Leadership', text: 'Guided by visionaries dedicated to educational excellence.' },
      sections: [
        { type: 'cards', items: [
          { title: 'Management', desc: 'The Keshav Memorial Education Society board.', icon: 'fa-user-tie' },
          { title: 'Principal', desc: 'Leading the academic and administrative excellence of KMIT.', icon: 'fa-user-graduate' },
        ]}
      ]
    },
    'about/campus': {
      hero: { eyebrow: 'Facilities', title: 'Campus & Infrastructure', text: 'A world-class environment designed for focused learning and research.' },
      sections: [
        { type: 'cards', items: [
          { title: 'Computing Labs', desc: 'Ultra-modern labs with the latest hardware and software.', icon: 'fa-microchip' },
          { title: 'Library', desc: 'Extensive digital and physical academic resources.', icon: 'fa-book-open' },
        ]}
      ]
    },
    'admissions': {
      hero: { eyebrow: 'Join KMIT', title: 'How to Apply', text: 'Take the first step towards a rewarding engineering career.' },
      sections: [
        { type: 'cards', items: [
          { title: 'Online Application', desc: 'Submit your application through our portal.', icon: 'fa-file-signature' },
          { title: 'Counseling', desc: 'Guidance sessions for prospective students.', icon: 'fa-users' },
        ]}
      ]
    },
    'admissions/faq': {
      hero: { eyebrow: 'Common Questions', title: 'Admissions FAQs', text: 'Find answers to the most frequently asked questions about KMIT admissions — from eligibility and branches to scholarships and campus facilities.' },
      sections: [
        { type: 'cards', eyebrow: 'Frequently Asked', title: 'Got Questions?', items: [
          { title: 'What is the EAPCET code for KMIT?', desc: 'The EAPCET institute code for KMIT (Keshav Memorial Institute of Technology) is KMIT.', icon: 'fa-clipboard-question' },
          { title: 'Which branches are available?', desc: 'KMIT offers B.Tech in CSE, CSE AI & ML, CSE Data Science, and Information Technology.', icon: 'fa-laptop-code' },
          { title: 'Is KMIT autonomous?', desc: 'Yes, KMIT is a private, autonomous engineering college affiliated to JNTU Hyderabad.', icon: 'fa-building-columns' },
          { title: 'Are there hostel facilities?', desc: 'KMIT does not operate a campus hostel, but numerous PGs are available in the surrounding Narayanguda area.', icon: 'fa-bed' },
          { title: 'Are scholarships available?', desc: 'Yes, KMIT supports all Telangana government-sanctioned scholarships including TS ePass.', icon: 'fa-indian-rupee-sign' },
          { title: 'Distance from Metro?', desc: 'KMIT is approximately 2 minutes walk from the Narayanguda Metro Station.', icon: 'fa-train-subway' },
        ]}
      ]
    },
    'placements': {
    ...
    'academics/evaluation': {
      hero: { eyebrow: 'Academic Policy', title: 'Teaching & Evaluation', text: 'KMIT follows a well-defined Teaching-Learning-Evaluation (TLE) framework that ensures consistent, fair, and transparent assessment of student learning outcomes.' },
      sections: [
        { type: 'stats', items: [{ label: 'Internal Marks', value: '30%' }, { label: 'External Exam', value: '70%' }, { label: 'Min to Pass', value: '40%' }, { label: 'Grade Points', value: '10' }] },
        { type: 'text', eyebrow: 'Assessment Split', title: 'Marks Distribution', content: ['30% Internal Assessment (IA) which includes written tests, assignments, and attendance.', '70% Semester End Examination (SEE) conducted by the university.'] }
      ]
    },
    'academics/calendar': {
    ...
    'academics/regulations': {
      hero: {
        eyebrow: 'Academics',
        title: 'Regulations',
        text: 'Course regulations, continuous evaluation systems, and academic guidelines for all engineering programmes at KMIT.'
      },
      sections: [
        {
          type: 'text',
    ...
    'academics/syllabus': {
      hero: { eyebrow: 'Curriculum', title: 'Regulations & Syllabus', text: 'Detailed course structures and syllabi for all engineering branches under various regulations.' },
      sections: [
        { type: 'cards', items: [{ title: 'KR-23 Regulation', desc: 'The most recent autonomous curriculum.', icon: 'fa-book' }, { title: 'KR-21 Regulation', desc: 'Previous curriculum for current senior batches.', icon: 'fa-book-open' }] }
      ]
    },
    'student-life/events': {
    ...
    'admissions/eligibility': {
      hero: { eyebrow: 'Admissions', title: 'Eligibility Criteria', text: 'Requirements for B.Tech admissions through EAPCET, ECET, and Management quotas.' },
      sections: [
        { type: 'text', eyebrow: 'Quick Guide', title: 'Who Can Apply?', content: ['Candidates must have passed 10+2 with Physics, Chemistry, and Mathematics.', 'Admissions are primarily based on EAPCET/ECET ranks and qualifying scores.'] }
      ]
    },
    'admissions/fees': {
    ...
    'admissions/faq': {
      hero: { eyebrow: 'Help', title: 'Frequently Asked Questions', text: 'Common queries regarding B.Tech admissions, infrastructure, and academics at KMIT.' },
      sections: [
        { type: 'cards', items: [
          { title: 'How to apply?', desc: 'Visit the admissions portal or contact our help desk for the EAPCET counseling process.', icon: 'fa-circle-question' },
          { title: 'Hostel facility?', desc: 'KMIT provides information on verified private hostels for boys and girls nearby.', icon: 'fa-hotel' }
        ]}
      ]
    },
    'student-life/finishing-school': {
      hero: { eyebrow: 'Genesis', title: 'Finishing School', text: 'The bridge between academic learning and industry readiness, focused on high-end technology training.' },
      sections: [
        { type: 'stats', items: [{ label: 'Tech Stacks', value: '12+' }, { label: 'Certified Students', value: '2000+' }] },
        { type: 'cards', items: [{ title: 'Full Stack Dev', desc: 'React, Node, and Cloud architecture.', icon: 'fa-code' }, { title: 'AI/ML Bootcamps', desc: 'Deep dive into neural networks.', icon: 'fa-brain' }] }
      ]
    },
    ...
    'research/workshops': {
      ...
      sections: [
        ...
        {
          type: 'images',
          items: [{ src: '/photos/research/bcw.jpg', alt: 'Digital Pathology Workshop Poster' }]
        },
        { 
          type: 'text', 
          eyebrow: 'Workshop', 
