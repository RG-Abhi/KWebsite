    ...
    >
      ...
      <section className="page-section">
        <div className="container">
          ...
          <ScrollReveal animation="fade-up">
          <div className="council-modern-table-wrapper" style={{ marginTop: '2rem' }}>
              ...
              <tbody>
                {events.map((event, index) => (
                  <tr key={event.id}>
                    ...
                    <td style={{ textAlign: 'center', opacity: 0.9 }}>
                      <span className="council-badge">{event.date}</span>
                    </td>
        ...
        <div className="container">
          ...
          <div style={{
            ...
            <div className="info-card fade-in-up">
              <div className="info-card-icon" style={{ background: 'rgba(0,128,128,0.1)', color: 'var(--primary-color)' }}>
                <i className="fa-solid fa-graduation-cap"></i>
              </div>
              <div>
                <h3>Student Mentorship</h3>
                <p>Alumni play an active role in advising current students, sharing industry expectations, and guide them in internships and projects.</p>
              </div>
            </div>
            ...
            <div className="info-card fade-in-up">
              ...
              <div>
                <h3>Placement Network</h3>
                <p>A strong alumni base facilitates career referrals, placement drives, and technical workshops to keep KMITians ahead in the corporate race.</p>
              </div>
            </div>
            ...
            <div className="info-card fade-in-up">
              ...
              <div>
                ...
                <p>Bringing alumni across different countries and professional paths onto a single platform to enable worldwide networking opportunities.</p>
              </div>
            </div>
          </div>
        </div>
